 ...
 */
package org.opendaylight.iotdm.onem2mbundleloader.cli.commands;
...
public class Onem2mBundleLoaderCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(Onem2mBundleLoaderCliTestCommand.class);
    protected final Onem2mBundleLoaderCliCommands service;

    public Onem2mBundleLoaderCliTestCommand(final Onem2mBundleLoaderCliCommands service) {
