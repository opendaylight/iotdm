...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.iotdm.onem2mbundleloader.rev150105.bundle.loader.startup.features.StartupFeatures;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.iotdm.onem2mbundleloader.rev150105.bundle.loader.startup.features.StartupFeaturesBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.iotdm.onem2mbundleloader.rev150105.bundle.loader.startup.features.StartupFeaturesKey;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.iotdm.onem2mbundleloader.rev150105.bundles.to.load.list.BundlesToLoad;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.iotdm.onem2mbundleloader.rev150105.bundles.to.load.list.BundlesToLoadBuilder;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.iotdm.onem2mbundleloader.rev150105.onem2m.bundle.loader.running.config.output.RunningConfigListBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.iotdm.onem2mbundleloader.rev150105.onem2m.bundle.loader.running.config.output.running.config.list.RunningFeatures;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.iotdm.onem2mbundleloader.rev150105.onem2m.bundle.loader.running.config.output.running.config.list.RunningFeaturesBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.iotdm.onem2mbundleloader.rev150105.onem2m.bundle.loader.running.config.output.running.config.list.running.features.RunningFeatureBundles;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.iotdm.onem2mbundleloader.rev150105.onem2m.bundle.loader.running.config.output.running.config.list.running.features.RunningFeatureBundlesBuilder;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.iotdm.onem2mbundleloader.rev150105.startup.config.content.StartupConfigListBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.iotdm.onem2mbundleloader.rev150105.startup.config.content.StartupConfigListKey;
 ...
 */
public class Onem2mBundleLoaderProvider implements IotdmPluginLoader, Onem2mbundleloaderService {
    private static final Logger LOG = LoggerFactory.getLogger(Onem2mBundleLoaderProvider.class);
     ...
     */
    public Onem2mBundleLoaderProvider(final DataBroker dataBroker,
        ...
        try {
            if (! this.loadedFeatures.containsKey(input.getFeatureName())) {
                return RpcResultBuilder
                               .<Onem2mBundleLoaderFeatureRemoveOutput> failed()
            ...
            return RpcResultBuilder.<Onem2mBundleLoaderFeatureRemoveOutput>success().buildFuture();
        } finally {
    ...
    public Future<RpcResult<Onem2mBundleLoaderCleanOutput>> onem2mBundleLoaderClean(
        ...
        return RpcResultBuilder.<Onem2mBundleLoaderCleanOutput>success().buildFuture();
    }
    ...
    public Future<RpcResult<Onem2mBundleLoaderFeaturePutOutput>> onem2mBundleLoaderFeaturePut(
        ...
        try {
            ...
            if (null != errMsg) {
                return RpcResultBuilder
                           .<Onem2mBundleLoaderFeaturePutOutput> failed()
                           .withError(RpcError.ErrorType.APPLICATION,
            ...
            return RpcResultBuilder.<Onem2mBundleLoaderFeaturePutOutput>success().buildFuture();
    ...
    public Future<RpcResult<Onem2mBundleLoaderFeatureReloadOutput>> onem2mBundleLoaderFeatureReload(
        ...
        try {
            if (! this.loadedFeatures.containsKey(input.getFeatureName())) {
                return RpcResultBuilder
                       .<Onem2mBundleLoaderFeatureReloadOutput> failed()
                       .withError(RpcError.ErrorType.APPLICATION,
        ...
        return RpcResultBuilder.<Onem2mBundleLoaderFeatureReloadOutput>success().buildFuture();
    }
    ...
    public Future<RpcResult<Onem2mBundleLoaderStartupConfigOutput>> onem2mBundleLoaderStartupConfig(
        ...
        Onem2mBundleLoaderStartupConfigOutput output =
                this.getStartupConfig(input.getBundleLoaderInstanceName(), input.getFeatureName());
        if (null == output) {
            return RpcResultBuilder
                           .<Onem2mBundleLoaderStartupConfigOutput> failed()
                           .withError(RpcError.ErrorType.APPLICATION,
    ...
    public Future<RpcResult<Onem2mBundleLoaderRunningConfigOutput>> onem2mBundleLoaderRunningConfig(
        ...
        try {
            ...
            Onem2mBundleLoaderRunningConfigOutputBuilder builder =
                    new Onem2mBundleLoaderRunningConfigOutputBuilder()
    ...
    public void init() {
        ...
        if (! Onem2mPluginManager.getInstance().registerPluginLoader(this)) {
        ...
        if (! Onem2mBundleLoaderRpcRouter.getInstance().registerBundleLoader(loaderInstanceName, this)) {
            ...
            LOG.info("Onem2mBundleLoaderProvider ({}) Session Initiated", loaderInstanceName);
        }
    }
    ...
    public void close() {
        ...
        try {
            ...
            if (!Onem2mPluginManager.getInstance().unregisterPluginLoader(this)) {
                LOG.error("BundleLoader: {}, Failed to unregister BundleLoader", loaderInstanceName);
            }
            LOG.info("BundleLoader: {}, Onem2mBundleLoaderProvider Closed", loaderInstanceName);
        } finally {
            this.rwLock.writeLock().unlock();
        }

        Onem2mBundleLoaderRpcRouter.getInstance().unregisterBundleLoader(loaderInstanceName);
    }
    ...
    private boolean delFeatureStartupConfig(Onem2mBundleLoaderFeatureRemoveInput input) {
        WriteTransaction writeTransaction = dataBroker.newWriteOnlyTransaction();
        InstanceIdentifier<StartupFeatures> iid =
                InstanceIdentifier.create(BundleLoaderStartupConfig.class)
    ...
    private Onem2mBundleLoaderStartupConfigOutput getStartupConfig(String bundleLoaderInstanceName,
                                                                   String featureName) {
        ReadTransaction readTransaction = dataBroker.newReadOnlyTransaction();
        Onem2mBundleLoaderStartupConfigOutputBuilder outputBuilder = new Onem2mBundleLoaderStartupConfigOutputBuilder();
