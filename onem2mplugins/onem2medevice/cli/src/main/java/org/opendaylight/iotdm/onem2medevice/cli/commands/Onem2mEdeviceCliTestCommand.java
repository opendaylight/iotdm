 ...
 */
package org.opendaylight.iotdm.onem2medevice.cli.commands;
...
public class Onem2mEdeviceCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(Onem2mEdeviceCliTestCommand.class);
    protected final Onem2mEdeviceCliCommands service;

    public Onem2mEdeviceCliTestCommand(final Onem2mEdeviceCliCommands service) {
