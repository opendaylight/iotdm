 ...
 */
package org.opendaylight.iotdm.iotdmkaraffeatureloader.cli.commands;
...
public class IotdmKarafFeatureLoaderCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(IotdmKarafFeatureLoaderCliTestCommand.class);
    protected final IotdmKarafFeatureLoaderCliCommands service;

    public IotdmKarafFeatureLoaderCliTestCommand(final IotdmKarafFeatureLoaderCliCommands service) {
