 ...
 */
package org.opendaylight.iotdm.iotdmbundleloader.cli.commands;
...
public class IotdmBundleLoaderCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(IotdmBundleLoaderCliTestCommand.class);
    protected final IotdmBundleLoaderCliCommands service;

    public IotdmBundleLoaderCliTestCommand(final IotdmBundleLoaderCliCommands service) {
