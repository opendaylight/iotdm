 ...
 */
package org.opendaylight.iotdm.itplugin1.cli.commands;
...
public class ItPlugin1CliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ItPlugin1CliTestCommand.class);
    protected final ItPlugin1CliCommands service;

    public ItPlugin1CliTestCommand(final ItPlugin1CliCommands service) {
