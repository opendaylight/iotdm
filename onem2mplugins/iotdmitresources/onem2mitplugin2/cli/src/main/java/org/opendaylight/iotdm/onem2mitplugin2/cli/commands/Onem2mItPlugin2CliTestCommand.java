 ...
 */
package org.opendaylight.iotdm.onem2mitplugin2.cli.commands;
...
public class Onem2mItPlugin2CliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(Onem2mItPlugin2CliTestCommand.class);
    protected final Onem2mItPlugin2CliCommands service;

    public Onem2mItPlugin2CliTestCommand(final Onem2mItPlugin2CliCommands service) {
