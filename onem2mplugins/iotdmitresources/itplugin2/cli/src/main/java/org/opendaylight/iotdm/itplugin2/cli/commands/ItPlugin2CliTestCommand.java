 ...
 */
package org.opendaylight.iotdm.itplugin2.cli.commands;
...
public class ItPlugin2CliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ItPlugin2CliTestCommand.class);
    protected final ItPlugin2CliCommands service;

    public ItPlugin2CliTestCommand(final ItPlugin2CliCommands service) {
