 ...
 */
package org.opendaylight.iotdm.onem2moic.cli.commands;
...
public class Onem2mOicCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(Onem2mOicCliTestCommand.class);
    protected final Onem2mOicCliCommands service;

    public Onem2mOicCliTestCommand(final Onem2mOicCliCommands service) {
