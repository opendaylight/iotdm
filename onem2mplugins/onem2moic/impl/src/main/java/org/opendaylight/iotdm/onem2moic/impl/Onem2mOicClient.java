...
public class Onem2mOicClient {
    ...
    public void printCoapResponse(CoapResponse coapResponse) {
    ...
    public void printPayloadBytes(CoapResponse coapResponse) {
