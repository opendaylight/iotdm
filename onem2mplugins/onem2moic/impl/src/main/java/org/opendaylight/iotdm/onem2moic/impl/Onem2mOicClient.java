...
public class Onem2mOicClient {
    ...
    public void oicParseInterfacePayload(byte payload[]) throws IOException {
        ...
        while (jParser.nextToken() != JsonToken.END_OBJECT) {
            ...
            switch(fieldname==null ? "" : fieldname) {
                case "if":
                    ...
                    while (jParser.nextToken() != JsonToken.END_ARRAY) {
                        if (jParser.getCurrentToken() != JsonToken.START_ARRAY) {
                            // TODO Need to populate to interface object
                            // which will be committed in next changes
                        }
                    }
                    continue;
                ...
                case "mnsl":
                case "rt":
                    // TODO Need to populate to interface object which will
                    // be committed in next changes
                    jParser.nextToken();
                    continue;
                default:
                    // TODO Need to discuss with OneM2M OIC Internetworking
                    // standard on how to handle this
                    jParser.nextToken();
                    continue;
            }
        }
        ...
        while (jParser.nextToken() != JsonToken.END_OBJECT) {
            ...
            switch (fieldname==null ? "" : fieldname) {
                case "if":
                    ...
                    while (jParser.nextToken() != JsonToken.END_ARRAY) {
                        if (jParser.getCurrentToken() != JsonToken.START_ARRAY) {
                           // TODO Need to populate to platform object
                            // which will be committed in next changes
                        }
                        continue;
                    }
     ...
     * TODO Need to populate to /oic/res object which will be committed in next changes,
     *      hence just parsing now
     *
