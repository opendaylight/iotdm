 ...
 */
package org.opendaylight.iotdm.onem2mkaraffeatureloader.cli.commands;
...
public class Onem2mKarafFeatureLoaderCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(Onem2mKarafFeatureLoaderCliTestCommand.class);
    protected final Onem2mKarafFeatureLoaderCliCommands service;

    public Onem2mKarafFeatureLoaderCliTestCommand(final Onem2mKarafFeatureLoaderCliCommands service) {
