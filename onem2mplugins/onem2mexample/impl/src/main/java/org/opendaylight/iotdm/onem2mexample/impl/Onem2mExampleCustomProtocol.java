...
import org.opendaylight.iotdm.onem2m.commchannels.http.Onem2mHttpResponse;
 ...
 */
public class Onem2mExampleCustomProtocol implements IotdmHandlerPlugin,
    ...
    /*
     * Example-1. Implementation of IotdmPlugin
     */
    @Override
    ...
    /*
     * Example-2. Implementation of IotdmHandlerPlugin interface
     */
    ...
    public void handle(IotdmPluginRequest request, IotdmPluginResponse response){
        ...
        HttpServletResponse httpResponse = ((Onem2mHttpResponse)response).getHttpResponse();
        ...
        LOG.info("Onem2mExampleCustomProtocol: method: {}, url:{}, headers: {}, payload: {}",
                 ...
                 ((Onem2mHttpRequest) request).getHeadersAll(), request.getPayLoad());
