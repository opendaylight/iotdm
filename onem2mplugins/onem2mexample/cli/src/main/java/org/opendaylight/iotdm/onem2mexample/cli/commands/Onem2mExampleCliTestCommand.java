 ...
 */
package org.opendaylight.iotdm.onem2mexample.cli.commands;
...
public class Onem2mExampleCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(Onem2mExampleCliTestCommand.class);
    protected final Onem2mExampleCliCommands service;

    public Onem2mExampleCliTestCommand(final Onem2mExampleCliCommands service) {
