...
public class Onem2mbenchmarkModuleTest {
    @Test
    public void testCustomValidation() {
        Onem2mbenchmarkModule module = new Onem2mbenchmarkModule(mock(ModuleIdentifier.class), mock(DependencyResolver.class));
