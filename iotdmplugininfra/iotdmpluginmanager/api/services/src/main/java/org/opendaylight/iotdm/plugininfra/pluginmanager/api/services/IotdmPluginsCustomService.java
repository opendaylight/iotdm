...
public interface IotdmPluginsCustomService {
     ...
     */
    CustomServicePluginData getServiceSpecificPluginData(IotdmPluginCommonInterface plugin);
     ...
     */
    PluginInstanceCustomData getPluginInstanceCustomData(IotdmPluginCommonInterface plugin);
