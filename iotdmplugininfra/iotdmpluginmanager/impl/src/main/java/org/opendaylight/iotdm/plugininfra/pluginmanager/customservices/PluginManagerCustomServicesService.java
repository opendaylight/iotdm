...
public class PluginManagerCustomServicesService implements IotdmPluginManagerCustomServicesService {
     ...
     */
    public Collection<IotdmPluginsCustomService> getServicesOfPlugin(IotdmPluginCommonInterface plugin) {
     ...
     */
    public Collection<IotdmPluginCommonInterface> getPluginsOfService(IotdmPluginsCustomService customService) {
     ...
     */
    public Collection<IotdmPluginCommonInterface> getAllPlugins() {
        List<IotdmPluginCommonInterface> list = new LinkedList<>();

        for (CustomServiceRegistryItem item : serviceRegistry.values()) {
            Collection<IotdmPluginCommonInterface> servicePlugins = item.getRegistry().getRegisteredPlugins();
    ...
    @Override
    public IotdmCommonPluginData createIotdmPluginData(IotdmPluginCommonInterface plugin) {
