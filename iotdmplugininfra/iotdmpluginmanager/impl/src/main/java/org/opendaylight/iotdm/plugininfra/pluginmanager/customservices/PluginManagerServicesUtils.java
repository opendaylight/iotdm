...
public final class PluginManagerServicesUtils {
    ...
    public static void handleRegistrationError(Logger LOG, String format, String... args)
        ...
        LOG.error("IotdmHandlerPlugin registration error: {}", msg);
    ...
    public static IotdmCommonPluginData createIotdmPluginData(final IotdmPlugin plugin,
                                                              String loaderName) {
        Map<String, IotdmPluginLoader> pluginLoaders = IotdmPluginManager.getInstance().getMgrPluginLoaders();
     ...
     */
    public static IotdmCommonPluginData createIotdmPluginData(IotdmPlugin plugin) {
