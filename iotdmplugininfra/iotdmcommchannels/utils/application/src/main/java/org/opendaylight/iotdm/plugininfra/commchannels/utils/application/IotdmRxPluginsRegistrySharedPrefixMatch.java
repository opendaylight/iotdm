...
//    private final AtomicReference<IotdmHandlerPlugin> plugin = new AtomicReference<>(null);
//
//    private boolean regPath(@Nonnull final String[] uri,
//                            int index,
//                            @Nonnull final IotdmHandlerPlugin plugin) {
//        String path = uri[index];
//        index++;
//
//        if (index == uri.length) {
//            // We are at the end of URI, register the plugin here
//            IotdmHandlerPlugin regPlugin = this.plugin.get();
//            if (regPlugin != null) {
...
//    }
//
//    public boolean registerPlugin(final String uri, @Nonnull final IotdmHandlerPlugin plugin) {
...
//    }
//
//    private boolean delPlugin(String uri, IotdmHandlerPlugin plugin) {
//        IotdmHandlerPlugin regPlugin = this.plugin.get();
//        if (null == regPlugin) {
...
//    }
//
//    private boolean unregPath(@Nonnull final String[] uri, int index, @Nonnull final IotdmHandlerPlugin plugin) {
//        if (index >= uri.length) {
...
//    }
//
//    private int unregAll(@Nonnull final IotdmHandlerPlugin plugin) {
//        int occurrences = 0;
//
...
//    }
//
//    public boolean unregisterPlugin(final String uri, @Nonnull final IotdmHandlerPlugin plugin) {
//        if (null == uri || uri.isEmpty() || uri.equals("/")) {
...
//    }
//
//    public boolean unregisterPlugin(@Nonnull final IotdmHandlerPlugin plugin) {
//        int occurrences = 0;
//
...
//    }
//
//    private IotdmHandlerPlugin getPluginAtSubPath(String [] uri, int index) {
//        IotdmHandlerPlugin plugin = null;
//
//        if (uri.length <= index) {
...
//    }
//
//    public IotdmHandlerPlugin getPlugin(@Nonnull final String uri) {
//        IotdmHandlerPlugin plugin = null;
//
...
//    }
//
//    public boolean hasPluginRegistered(@Nonnull final IotdmHandlerPlugin plugin) {
//        if (this.plugin.get() != null && this.plugin.get().isPlugin(plugin)) {
//            return true;
//        }
//
...
//    }
//
//    private boolean hasPluginRegisteredAtSubPath(String [] uri, int index, @Nonnull final IotdmHandlerPlugin plugin) {
//        if (index >= uri.length) {
//            // we are at the end of URI, the plugin should be registered here
...
//    }
//
//    public boolean hasPluginRegistered(@Nonnull final IotdmHandlerPlugin plugin, @Nonnull final String uri) {
//        if (uri.isEmpty() || uri.equals("/")) {
...
//    }
//
//    private void getPluginMap(Map<String, IotdmHandlerPlugin> map, String currentUrl) {
//        IotdmHandlerPlugin plugin = this.plugin.get();
//        if (null != plugin) {
...
//    }
//
//    public Map<String, IotdmHandlerPlugin> getPluginMap() {
//        Map<String, IotdmHandlerPlugin> map = new HashMap<>();
