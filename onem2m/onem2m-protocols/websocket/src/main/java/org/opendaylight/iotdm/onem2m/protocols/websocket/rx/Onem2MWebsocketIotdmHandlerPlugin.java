...
public class Onem2MWebsocketIotdmHandlerPlugin implements
                                               IotdmHandlerPlugin<IotdmPluginOnem2mBaseRequest, IotdmPluginOnem2mBaseResponse>,
                                        Onem2mProtocolRxChannel {
    private static final Logger LOG = LoggerFactory.getLogger(Onem2MWebsocketIotdmHandlerPlugin.class);
    ...
    private Onem2mProtocolWebsocketProviders currentConfig = null;

    public Onem2MWebsocketIotdmHandlerPlugin(@Nonnull final Onem2mProtocolRxHandler requestHandler,
    ...
    //@Override
    public void start(Onem2mProtocolWebsocketProviders configuration)
        ...
        try {
            IotdmPluginManager.getInstance()
                              .registerPluginWebsocket(this, configuration.getServerPort().getValue(),
