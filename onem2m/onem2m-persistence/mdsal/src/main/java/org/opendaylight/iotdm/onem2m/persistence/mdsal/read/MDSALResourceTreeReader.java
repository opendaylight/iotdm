...
public class MDSALResourceTreeReader implements DaoResourceTreeReader {
    ...
    @Override
    public Onem2mParentChild retrieveChildByName(String resourceId, String name) throws IotdmDaoReadException {
    ...
    private <U extends org.opendaylight.yangtools.yang.binding.DataObject> U retrieve(
            ...
            LogicalDatastoreType logicalDatastoreType) throws IotdmDaoReadException {
        try {
            try (ReadOnlyTransaction readOnlyTransaction = broker.newReadOnlyTransaction()) {
                ...
                try {
                    ...
                    throw new IotdmDaoReadException("Read failed");
                }
                return ret;
            }
            ...
            throw new IotdmDaoReadException("Retrieve fail due to miscelaneous reason");
        }
    }
    @Override
    public void close() {
