 ...
 * @author jkosmel
 */
public class IotdmMqttPluginClientRx extends IotdmBaseRxCommunicationChannel {
    private static final Logger LOG = LoggerFactory.getLogger(IotdmMqttPluginClientRx.class);
    ...
    IotdmMqttPluginClientRx(String ipAddress, int port,
