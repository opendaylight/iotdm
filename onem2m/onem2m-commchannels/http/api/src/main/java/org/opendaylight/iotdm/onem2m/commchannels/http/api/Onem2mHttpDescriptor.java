...
public class Onem2mHttpDescriptor extends IotdmRxDescriptorApplication<IotdmRxAppProtocolConfigurationNone> {

    protected Onem2mHttpDescriptor(
        final IotdmRxDescriptorApplicationInterface intDesc,
        final IotdmRxDescriptorApplicationProtocol<IotdmRxAppProtocolConfigurationNone> protoDesc,
