 ...
 * back to the client.
 */
public class Onem2mHttpResponse extends Onem2mProtocolPluginResponse {
    private static final Logger LOG = LoggerFactory.getLogger(Onem2mHttpResponse.class);
    ...
    public Onem2mHttpResponse(HttpServletResponse httpResponse) {
