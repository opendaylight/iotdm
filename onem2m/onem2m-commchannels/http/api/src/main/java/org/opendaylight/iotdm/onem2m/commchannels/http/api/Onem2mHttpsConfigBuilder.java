 ...
 */
public class Onem2mHttpsConfigBuilder extends HttpsServerConfiguration
    implements IotdmPluginConfigurationBuilder<HttpsServerConfiguration> {
     ...
     */
    @Override
    public Onem2mHttpsConfigBuilder verify() throws IllegalArgumentException {
    ...
    @Override
    public HttpsServerConfiguration build() throws IllegalArgumentException {
        verifyAll();
    ...
    public Onem2mHttpsConfigBuilder setUseDefault(boolean useDefault) {
        this.usesDefaultConfig = useDefault;
        return this;
    }

    public Onem2mHttpsConfigBuilder setKeyStoreFile(String keyStoreFile) {
        this.keyStoreFile = keyStoreFile;
        return this;
    }

    public Onem2mHttpsConfigBuilder setKeyStorePassword(String keyStorePassword) {
        this.keyStorePassword = keyStorePassword;
        return this;
    }

    public Onem2mHttpsConfigBuilder setKeyManagerPassword(String keyManagerPassword) {
