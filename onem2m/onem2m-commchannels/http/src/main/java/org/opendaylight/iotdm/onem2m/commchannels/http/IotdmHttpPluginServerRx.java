 ...
 */
public class IotdmHttpPluginServerRx extends IotdmHttpBaseRxChannel {
    public static final String ProtocolHTTP = "http";
    public IotdmHttpPluginServerRx(String ipAddress, int port,
 ...
 */
class IotdmHttpBaseRxChannel<Tconfig> extends IotdmBaseRxCommunicationChannel<Tconfig> {
    private static final Logger LOG = LoggerFactory.getLogger(IotdmHttpPluginServerRx.class);
    protected Server httpServer;
    private FilterHolder cors;
    private ServletContextHandler context;
    private Onem2mHttpBaseHandler onem2mHttpBaseHandler;

    public IotdmHttpBaseRxChannel(String ipAddress, int port,
                                  IotdmRxPluginsRegistryReadOnly registry,
