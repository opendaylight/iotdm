...
public class Onem2mDb implements TransactionChainListener {
     ...
     */
    public List<String> directParentSubscriptionIds(RequestPrimitive requestPrimitive, String eventType, boolean skipSelfNotify) {
        ...
        if (parentResourceid.equals(Onem2mDb.NULL_RESOURCE_ID)) {
            ...
            try {
                ...
                LOG.warn("directParentSubscriptionIds: {}", e.toString());
                return subscriptionIds;
            }
        }
