 ...
 *
 * 1) start a transaction eg. DbTransaction txn = new DbTransaction(BindingTransactionChain btc)
...
public class DbTransaction {
    ...
    public DbTransaction(BindingTransactionChain bindingTransactionChain) {
        ...
        this.writeTx = bindingTransactionChain.newWriteOnlyTransaction();
    }
    ...
    public static <U extends org.opendaylight.yangtools.yang.binding.DataObject> U retrieve (
        ...
        U ret = null;
        ReadOnlyTransaction readTx = bindingTransactionChain.newReadOnlyTransaction();
