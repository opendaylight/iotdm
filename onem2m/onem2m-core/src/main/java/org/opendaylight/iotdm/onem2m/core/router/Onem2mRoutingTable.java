 ...
 */
class CseRoutingDataBase extends CseRoutingData {
...
public class Onem2mRoutingTable {
    ...
    private ConcurrentHashMap<String, CseRoutingDataBase> cseBaseMap = new ConcurrentHashMap<>();
    // cseBase routing data by cseBase cseID
    private ConcurrentHashMap<String, CseRoutingDataBase> cseBaseMapByCseId = new ConcurrentHashMap<>();

    /**
     * Deletes all data from routing table
     */
    public void cleanRoutingTable() {
        this.cseBaseMap = new ConcurrentHashMap<>();
        this.cseBaseMapByCseId = new ConcurrentHashMap<>();
    }
