...
public class Onem2mDbApiProvider implements Onem2mDbApiService, Onem2mPluginsDbApi,
    ...
    @Override
    public CustomServicePluginData getServiceSpecificPluginData(IotdmPlugin plugin) {
    ...
    @Override
    public PluginInstanceCustomData getPluginInstanceCustomData(IotdmPlugin plugin) {
