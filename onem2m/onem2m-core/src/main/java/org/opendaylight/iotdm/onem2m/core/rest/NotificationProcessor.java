...
public class NotificationProcessor {
    ...
    private void handleEventTypeA(RequestPrimitive onem2mRequest) {
        List<String> subscriptionsResourceIds = Onem2mDb.getInstance().findSelfSubscriptionID(onem2mRequest, UPDATE_RESOURCE);
    ...
    private void handleEventTypeB(RequestPrimitive onem2mRequest) {
        List<String> subscriptionsResourceIds = Onem2mDb.getInstance().findSelfSubscriptionID(onem2mRequest, DELETE_RESOURCE);
        ...
        for (String eventType : eventTypes) {
            if(!eventType.equals(UPDATE_RESOURCE) || parentHasStateTag(onem2mRequest)) {
                ...
                List<String> subscriptionsResourceIds = Onem2mDb.getInstance()
                                                       .directParentSubscriptionsResourceIds(onem2mRequest, eventType, isCreateChild);
