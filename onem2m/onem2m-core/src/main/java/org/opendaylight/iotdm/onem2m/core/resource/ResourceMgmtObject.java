    ...
    public static void processCreateUpdateAttributes(RequestPrimitive onem2mRequest, ResponsePrimitive onem2mResponse) {
        ...
        switch (mgd) {
            ...
            case Onem2m.SpecializedResource.SOFTWARE:
                ...
                String install = resourceContent.getInJsonContent().optString(Software.INSTALL, null);
                String uninstall = resourceContent.getInJsonContent().optString(Software.UNINSTALL, null);
                if (onem2mRequest.isCreate && (swnm == null || svr == null || surl == null || install == null || uninstall == null)) {
            ...
            case Onem2m.SpecializedResource.AREA_NWK_INFO:
                ...
                JSONArray listOfDevices = resourceContent.getInJsonContent().getJSONArray(AreaNwkInfo.LIST_OF_DEVICES);
            ...
            case Onem2m.SpecializedResource.AREA_NWK_DEVICE_INFO:
                ...
                JSONArray listOfNeighbors = resourceContent.getInJsonContent().getJSONArray(AreaNWkDeviceInfo.LIST_OF_NEIGHBORS);
            ...
            case Onem2m.SpecializedResource.BATTERY:
                ...
                if (onem2mRequest.isCreate && (batteryLevel == null || batteryStatus == null )) {
                    onem2mResponse.setRSC(Onem2m.ResponseStatusCode.BAD_REQUEST, "batteryLevel or batteryStatus is missing ");
                    return;
                }
                break;
            ...
            case Onem2m.SpecializedResource.DEVICE_CAPABILITY:
                ...
                String attached = resourceContent.getInJsonContent().optString(DeviceCapability.ATTACHED, null);
                String cababilityActionStatus = resourceContent.getInJsonContent().optString(DeviceCapability.CAPABILITY_ACTION_STATUS, null);
                if (onem2mRequest.isCreate && (capabilityName == null || attached == null || cababilityActionStatus == null)) {
            ...
            case Onem2m.SpecializedResource.EVENT_LOG:
                ...
                if (onem2mRequest.isCreate && (logTypeId == null || logData == null || logStatus == null||logStart == null || logStop == null)) {
            ...
            case Onem2m.SpecializedResource.CMDH_POLICY:
                ...
                JSONArray cmdh_poli_mgmtlink = resourceContent.getInJsonContent().getJSONArray(CmdhPolicy.MGMT_LINK);
            ...
            case Onem2m.SpecializedResource.ACTIVE_CMDH_POLICY:
                JSONArray act_cmd_mgmtlink = resourceContent.getInJsonContent().getJSONArray(CmdhPolicy.MGMT_LINK);
            ...
            case Onem2m.SpecializedResource.CMDH_DEFAULTS:
                JSONArray cmdh_defaults = resourceContent.getInJsonContent().getJSONArray(CmdhDefaults.MGMT_LINK);
            ...
            case Onem2m.SpecializedResource.CMDH_DEFEC_VALUE:
                ...
                JSONArray requestOrigin = resourceContent.getInJsonContent().getJSONArray(CmdhDefEcValue.REQUEST_ORIGIN);
            ...
            case Onem2m.SpecializedResource.CMDH_ECDEF_PARAM_VALUES:
                JSONArray applicableEventCategory = resourceContent.getInJsonContent().getJSONArray(CmdhEcEefParamValues.APPLICABLE_EVENT_CATEGORY);
            ...
            case Onem2m.SpecializedResource.CMDG_LIMITS:
                ...
                JSONArray lrequestOrigin = resourceContent.getInJsonContent().getJSONArray(CmdhDefEcValue.REQUEST_ORIGIN);
                if (onem2mRequest.isCreate && (lorder == null || lrequestOrigin == null)) {
                    onem2mResponse.setRSC(Onem2m.ResponseStatusCode.BAD_REQUEST, "order, requestOrigin is missing ");
                    return;
                }
                JSONArray limitsEventCategory = resourceContent.getInJsonContent().getJSONArray(CmdhLimits.LIMITS_EVENT_CATEGORY);
            ...
            case Onem2m.SpecializedResource.CMDH_NETWORK_ACCESS_RULES:
                JSONArray applicableEventCategories = resourceContent.getInJsonContent().getJSONArray(CmdhNetworkAccessRules.APPLICABLE_EVENT_CATEGORIES);
