define(["moment", "ngMaterial"], function(moment) {
    (function(moment) {
        'use strict';
                    ...
                    return {
                        ...
                        link: function(scope, element, attrs, ngModel) {
                            ...
                            if (angular.isString(scope.currentDate) && scope.currentDate !== '') {
                                scope.currentDate = moment(scope.currentDate, scope.format)._d;
                            }
                            ...
                            element.on('focus', function(e) {
                                ...
                                $mdDialog.show({
                                    ...
                                    .then(function(v) {
                                        ngModel.$setViewValue(v ? v._d : v);
                                        ngModel.$render();
                                        var mdInputContainerDom = element.parent();
                                        mdInputContainerDom.removeClass('md-input-focused');
                                    }, function() {
                                        var mdInputContainerDom = element.parent();
                                        mdInputContainerDom.removeClass('md-input-focused');
                                    });
